  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{venda ? "Editar Venda" : "Adicionar Venda"}</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="periodo"
              placeholder="Ex: Janeiro/2024 ou 2024-01"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button type="button" onClick={handleAddProduto} size="icon" variant="outline">
          ...
          <DialogFooter>
            ...
            <Button type="submit">{venda ? "Atualizar" : "Adicionar"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
